	$(window).load(function(){
        ...
        if($(".inside-tabbar li").length>0){
	    	if($(".inside-tabbar li").length==1){
	           
		     $(".inside-tabbar li").css("width","100%");
				
	        }else if($(".inside-tabbar li").length==2){
	          $(".inside-tabbar li").css("width","50%");
		      
	        }else if($(".inside-tabbar li").length==3){
	        	$(".inside-tabbar li").css("width","33.33%");
	        }
	    }
	    ...
	    if($(".type-tabbar-swiper").length>0){
	    	if(type_tabbar_swiper.slides.length==1){
	
		        type_tabbar_swiper = new Swiper('.type-tabbar-swiper', {
				    slidesPerView: 1
				});	
				
	       }else if(type_tabbar_swiper.slides.length==2){
	
		        type_tabbar_swiper = new Swiper('.type-tabbar-swiper', {
				    slidesPerView: 2
				});	
				
	        }else if(type_tabbar_swiper.slides.length==3){
	        	type_tabbar_swiper = new Swiper('.type-tabbar-swiper', {
				    slidesPerView: 3
				});	
	        }
